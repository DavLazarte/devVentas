...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('detalle_compras', function (Blueprint $table) {
            ...
            $table->string('unidad_medida_compra', 10)->nullable()->after('cantidad_decimal')
                ->comment('Unidad de medida de la compra (kg, g, lb, l, ml)');
        });
    }
    ...
    {
        Schema::table('detalle_compras', function (Blueprint $table) {
            $table->dropColumn(['cantidad_decimal', 'unidad_medida_compra']);
        });
    }
};
