<div>
    ...
    <header class="sticky top-0 z-10 bg-white shadow-sm">
        <div class="container mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <!-- Title -->
            <h1 class="text-lg font-semibold text-gray-900">Resumen de Compra</h1>
    ...
    <main class="pb-24">
        ...
        <div class="bg-white mb-2">
            <div class="px-4 py-3 border-b border-gray-200">
                ...
                <p class="text-sm text-gray-600">{{ count($items) }} {{ count($items) === 1 ? 'artículo' : 'artículos' }}</p>
            </div>
        ...
        <div class="bg-white px-4 py-4 mb-2">
            ...
            <form wire:submit.prevent="procesarPedido" class="space-y-4">
                ...
                {{-- <div class="flex items-start space-x-3">
                    <input type="checkbox" id="crear_cuenta" wire:model="crear_cuenta" class="mt-1 text-purple-600 focus:ring-purple-500 rounded">
                    <div>
                        <label for="crear_cuenta" class="font-medium text-gray-900 cursor-pointer">
                            Crear una cuenta
                        </label>
                        <p class="text-sm text-gray-600 mt-1">
                            Guarda tu información para futuras compras y recibe ofertas exclusivas
                        </p>
                    </div>
                </div> --}}
