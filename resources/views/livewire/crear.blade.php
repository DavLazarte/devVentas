                ...
                <form>
                    <div class="bg-white px-4 pt-5 pb-4 sm:p-4 sm:pb-2">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="peso" wire:model="peso">
                        </div>
                        <div class="mb-4">
