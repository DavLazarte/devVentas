                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 p-6">
                    ...
                    <div class="col-span-1 bg-white p-6 shadow rounded-lg">
                        ...
                        <button wire:click="guardar()"
                            class="w-full bg-purple-600 text-white py-2 px-4 rounded-md shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500">Cargar
                            Venta</button>
                    </div>
                </div>
            </div>
