<main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
    <div class="container px-6 py-8 mx-auto">
        ...
        <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
            <!-- Ventas Totales -->
            <div class="flex items-center p-4 bg-white border-l-4 border-orange-500 rounded-lg shadow-sm dark:bg-gray-800">
                <div class="p-3 mr-4 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full">
                    <svg class="w-6 h-6 text-white" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <!-- Ventas Efectivo -->
            <div class="flex items-center p-4 bg-white border-l-4 border-green-500 rounded-lg shadow-sm dark:bg-gray-800">
            ...
            <div class="flex items-center p-4 bg-white border-l-4 border-blue-500 rounded-lg shadow-sm dark:bg-gray-800">
            ...
            <!-- Ventas Cuentas -->
            <div class="flex items-center p-4 bg-white border-l-4 border-gray-800 rounded-lg shadow-sm dark:bg-gray-800">
                ...
                <div>
                    <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-400">Total Ventas de Cuentas y Tarjetas </p>
            ...
            <div class="flex items-center p-4 bg-white border-l-4 border-red-800 rounded-lg shadow-sm dark:bg-gray-800">
                <div class="p-3 mr-4 bg-gradient-to-br from-red-700 to-red-900 rounded-full">
                    <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.25 9.75h4.875a2.625 2.625 0 0 1 0 5.25H12M8.25 9.75 10.5 7.5M8.25 9.75 10.5 12m9-7.243V21.75l-3.75-1.5-3.75 1.5-3.75-1.5-3.75 1.5V4.757c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0c1.1.128 1.907 1.077 1.907 2.185Z"/>
                    </svg>
                </div>
                <div>
            ...
            <!-- Compras en Efectivo -->
            <div class="flex items-center p-4 bg-white border-l-4 border-lime-800 rounded-lg shadow-sm dark:bg-gray-800">
                ...
                <div>
                    ...
                    <p class="text-lg font-semibold text-gray-700 dark:text-gray-200">{{ round($compras_efectivo,2) }}</p>
                </div>
            </div>
        
            <!-- Compras por transferencias -->
            <div class="flex items-center p-4 bg-white border-l-4 border-teal-800 rounded-lg shadow-sm dark:bg-gray-800">
            ...
            <!-- Cobros Cuentas -->
            <div class="flex items-center p-4 bg-white border-l-4 border-yellow-500 rounded-lg shadow-sm dark:bg-gray-800">
            ...
            <div class="flex items-center p-4 bg-white border-l-4 border-red-600 rounded-lg shadow-sm dark:bg-gray-800">
                <div class="p-3 mr-4 bg-gradient-to-br from-red-500 to-red-700 rounded-full">
                    <svg class="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m11.25 9-3 3m0 0 3 3m-3-3h7.5M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                    </svg>
                </div>
                <div>
                    <div>
