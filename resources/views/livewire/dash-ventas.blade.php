            ...
            <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-600">{{ $ventas_transferencia }}
                        </p>
                    </div>
                </div>
                ...
                <!-- Compras Totales -->
                <div
                    class="flex items-center p-4 bg-white border-l-4 border-red-800 rounded-lg shadow-sm dark:bg-gray-800">
                ...
                <div
                    ...
                    <div>
                        <p class="mb-2 text-sm font-medium text-gray-600 dark:text-gray-800">Compras por transferencias
                        </p>
                        <p class="text-lg font-semibold text-gray-700 dark:text-gray-600">{{ $compras_transferencia }}
                        </p>
                    </div>
                </div>
                ...
                <!-- Salidas -->
                <div
                    class="flex items-center p-4 bg-white border-l-4 border-red-600 rounded-lg shadow-sm dark:bg-gray-800">
